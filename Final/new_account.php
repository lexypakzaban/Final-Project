...
<body style="background-color:#ff99ce;">
<?php
	require("../social_media_connector.php"); // YOU SHOULD DO THIS --> update this to the path for your connector.php file.
	$LOGIN_PAGE_URL = "Login.php";  // YOU SHOULD DO THIS --> update this to be the page where your login screen resides. 
	$MY_DOMAIN_URL = "http://lexy.pakzaban.kinkaid.org"; // YOU SHOULD DO THIS --> update this to the URL for your overall site (replace my name with yours).
...
<table style="margin-left: auto; margin-right: auto; border: 1px solid black; background-color: #ffcce6;">
	...
	<tr><td>By creating this account, I agree to be respectful and kind.</td></tr>
	<tr><td>I will not post anything inappropriate or use this account to bully others.</td></tr>
	<tr><td>(If these Terms of Service are not met, this account will be deleted.)</td></tr>
